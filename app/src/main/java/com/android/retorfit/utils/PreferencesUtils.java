...
public class PreferencesUtils {
	...
	public static boolean putString(Context context, String preferencesName, String key, String value) {
		SharedPreferences settings = context.getSharedPreferences(preferencesName, Context.MODE_MULTI_PROCESS);
	...
	public static String getString(Context context, String key, String defaultValue) {
		...
		if (TextUtils.isEmpty(getString(context, PREFERENCE_NAME, key, defaultValue))) {
			return defaultValue;
		} else {
	...
	public static long getLong(Context context, String key, long defaultValue) {
		try {
			...
			return getInt(context, PREFERENCE_NAME, key, 0);
		}
	};
	...
	public static void clear(Context context, String preferenceName) {
		...
		SharedPreferences settings = context.getSharedPreferences(preferenceName, Context.MODE_MULTI_PROCESS);
		SharedPreferences.Editor editor = settings.edit();
		editor.clear();
		editor.commit();
	}
